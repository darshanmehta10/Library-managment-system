...
$(document).ready(function () {
    ...
    $("#addAuthor").click(function () {
        ...
        authorsBlock += "                        <input class=\"validate\" id=\"first_name\" placeholder=\"Title\" type=\"text\" name=\"authors[{0}].name\" value=\"\">";
        authorsBlock += "                        <label for=\"first_name\" class=\"active\">Author<\/label>";
        authorsBlock += "                    <\/div>";
        authorsBlock += "                    <div class=\"input-field col s4\">";
        authorsBlock += "                        <input class=\"validate\" id=\"last_name\" type=\"text\" name=\"authors[{0}].lastName\" value=\"\">";
        authorsBlock += "                        <label for=\"last_name\">Name<\/label>";
        authorsBlock += "                    <\/div>";
        ...
        authorsBlock += "                        <label for=\"last_name\">Surname<\/label>";
        authorsBlock += "                    <\/div>";
        authorsBlock += "                <\/div>";
        authorsBlock += "";
